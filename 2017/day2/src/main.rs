const INPUT: &'static str = "3093	749	3469	142	2049	3537	1596	3035	2424	3982	3290	125	249	131	118	3138
...
fn part1() -> i32 {
    ...
    for line in INPUT.lines() {
        let mut values = line.split_whitespace()
            ...
            .collect::<Vec<_>>();
        values.sort();
        checksum += values[values.len() - 1] - values[0];
    }
    checksum
}
...
fn part2() -> i32 {
    ...
    for line in INPUT.lines() {
        let values = line.split_whitespace()
            .map(|x| x.parse::<i32>().unwrap())
            .collect::<Vec<_>>();
        for numerator in values.clone() {
            for denominator in values.clone() {
